    ...
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <Sequence name="Scene 4: Title - Supplement Intro" from={scene2bStart} durationInFrames={TITLE_DURATION}>
        <AbsoluteFill>
          <Video
            muted
            src={staticFile("ads-studio-brands-16x9-title1b.mp4") + "?v=" + ASSET_CACHE_BUST}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      <Sequence name="Scene 13: Rotato Brand Demo" from={rotatoStart} durationInFrames={ROTATO_DURATION}>
        <AbsoluteFill>
          <Video
            muted
            src={staticFile("rotato-brand-16x9.mp4") + "?v=" + ASSET_CACHE_BUST}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
...
// Demo placement text overlay - 50px from left (for Scene 1)
