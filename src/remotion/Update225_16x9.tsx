...
// Part 1: Intro
const scene1 = { name: "Intro", clip: "intro-16x9-2.mp4", duration: 180 };
const scene2 = { name: "Main Title", clip: "main-title-16x9-48.mp4", duration: 120 };
const scene3 = { name: "Update Title", clip: "update-title-16x9-3.mp4", duration: 120 };
const scene4 = { name: "Main Title 2", clip: "main-title-16x9-49.mp4", duration: 120 };
const scene5 = { name: "Step Title", clip: "step-title-16x9-14.mp4", duration: 120 };
const scene6 = { name: "Home", clip: "home-ads.mp4", duration: 602 };
const scene7 = { name: "Step Title 2", clip: "step-title-16x9-4.mp4", duration: 120 };
const scene8 = { name: "Tasks", clip: "tasks-ads.mp4", duration: 599 };
const scene9 = { name: "Step Title 3", clip: "step-title-16x9-5.mp4", duration: 120 };
const scene10 = { name: "Assets", clip: "assets-ads.mp4", duration: 415 };
const scene11 = { name: "Step Title 4", clip: "step-title-16x9-6.mp4", duration: 120 };
const scene12 = { name: "Campaigns", clip: "campaigns-ads.mp4", duration: 1087 };
const scene13 = { name: "Step Title 5", clip: "step-title-16x9-7.mp4", duration: 120 };
const scene14 = { name: "Analytics", clip: "analytics-ads.mp4", duration: 260 };
const scene15 = { name: "Step Title 6", clip: "step-title-16x9-15.mp4", duration: 120 };
const scene16 = { name: "Main Title 3", clip: "main-title-16x9-50.mp4", duration: 120 };
const scene18 = { name: "Home", clip: "Home-Studio.mp4", duration: 452 };
const scene19 = { name: "Step Title 7", clip: "step-title-16x9-9.mp4", duration: 120 };
const scene20 = { name: "Tasks", clip: "tasks-studio.mp4", duration: 419 };
const scene21 = { name: "Step Title 8", clip: "step-title-16x9-10.mp4", duration: 120 };
const scene22 = { name: "Videos", clip: "Videos-Studio.mp4", duration: 598 };
const scene23 = { name: "Step Title 9", clip: "step-title-16x9-11.mp4", duration: 120 };
const scene24 = { name: "Adslots", clip: "adslots-ads.mp4", duration: 376 };
const scene25 = { name: "Step Title 10", clip: "step-title-16x9-12.mp4", duration: 120 };
const scene26 = { name: "Payouts", clip: "payouts-ads.mp4", duration: 301 };
const scene27 = { name: "Domain", clip: "domain-16x9-4.mp4", duration: 120 };
const scene28 = { name: "Outro", clip: "outro-16x9-4.mp4", duration: 90 };
...
// COMPONENT
// =============================================================================
export const Update225_16x9: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <Sequence name={`Scene 21: ${scene22.name}`} from={getStartTime(20)} durationInFrames={scene22.duration}>
        <Video src={staticFile(scene22.clip)} />
      </Sequence>
