...
// New Animation - BEAT SYNCED VERSION - 16x9
export const NewAnimation02_16x9: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <Sequence from={c1a} durationInFrames={halfBeat}><VideoClipScene src="clip-1.mp4" title="Static Placement (poster)" /></Sequence>
