...
export const AdsStudio005_16x9: React.FC = () => {
  return (
...
// Scene 3: Hold on right, then slide to reveal subject
const Scene3SlideReveal: React.FC = () => {
  const frame = useCurrentFrame();
  
  const SLIDE_DURATION = 15; // 0.5 seconds slide
  
  // Slide from right (100%) to center (50%) starting immediately
