...
const TOTAL_DURATION = INTRO_DURATION + TAGLINE_DURATION + (TITLE_DURATION * 3) + STACKED_DURATION + STACKED2_DURATION + STACKED3_DURATION + PRE_OUTRO_DURATION + OUTRO1_DURATION + OUTRO2_DURATION;

export const AdsStudio009_16x9: React.FC = () => {
    ...
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <Sequence name="Scene 1: Intro" from={scene1Start} durationInFrames={INTRO_DURATION}>
        <AbsoluteFill>
          <Video
            volume={0.65}
            src={staticFile("ads-studio-accessory-16x9-intro.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      {/* Scene 4: Stacked - Handbag Before/After */}
      <Sequence name="Scene 4: Stacked - Handbag Before/After" from={scene4Start} durationInFrames={STACKED_DURATION}>
        <StackedVideoScene />
        <DemoPlacementText />
      </Sequence>

      {/* Scene 5: Title - Wearables Intro */}
      <Sequence name="Scene 5: Title - Wearables Intro" from={scene5Start} durationInFrames={TITLE_DURATION}>
        <AbsoluteFill>
          <Video
            muted
            src={staticFile("02-title-podcast-16x9.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      {/* Scene 6: Stacked - Wearables Before/After */}
      <Sequence name="Scene 6: Stacked - Wearables Before/After" from={scene6Start} durationInFrames={STACKED2_DURATION}>
        <StackedVideoScene2 />
        <DemoPlacementText />
      </Sequence>

      {/* Scene 7: Title - Headphones Intro */}
      <Sequence name="Scene 7: Title - Headphones Intro" from={scene7Start} durationInFrames={TITLE_DURATION}>
        <AbsoluteFill>
          <Video
            muted
            src={staticFile("03-title-podcast-16x9.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      {/* Scene 8: Stacked - Headphones Before/After */}
      <Sequence name="Scene 8: Stacked - Headphones Before/After" from={scene8Start} durationInFrames={STACKED3_DURATION}>
        <StackedVideoScene3 />
        <DemoPlacementText />
      </Sequence>
...
const StackedVideoScene: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <CenteredTitleOverlay title="Handbag" />
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      >
        <Video
          muted
          src={staticFile("ads-studio-009-stacked3-top.mp4")}
          style={{
            width: "100%",
            height: "100%",
            objectFit: "cover",
      ...
      {/* Centered title overlay */}
      <CenteredTitleOverlay title="Headphones" />
