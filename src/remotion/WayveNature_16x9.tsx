...
const SCENE2_DURATION = 90;   // 3 seconds - title-podcast-16x9.mp4
...
export const WayveNature_16x9: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      {/* Scene 2: title-podcast-16x9.mp4 */}
      ...
      {/* Scene 4: title-podcast-16x9.mp4 */}
      ...
      {/* Scene 5: title-podcast-16x9.mp4 */}
