...
export const AdsStudio001_16x9: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <Sequence from={0} durationInFrames={SCENE1_DURATION}>
        <AbsoluteFill>
          {/* Left video - empty scene (no Prime drink), muted */}
          <div
            style={{
              position: "absolute",
              top: 0,
          ...
          {/* Right video - scene with Prime drink, audio plays from this one */}
          <div
            style={{
              position: "absolute",
              top: 0,
      ...
      {/* Scene 5: Side by side videos - 2 seconds */}
      <Sequence from={SCENE1_DURATION + SCENE2A_DURATION + SCENE2B_DURATION + SCENE3_DURATION + SCENE_TEXT_DURATION} durationInFrames={SCENE4_DURATION}>
        <AbsoluteFill>
          {/* Left video - audio plays from this one */}
          <div
            style={{
              position: "absolute",
              top: 0,
          ...
          {/* Right video - muted to prevent overlap */}
          <div
            style={{
              position: "absolute",
              top: 0,
