...
export const AdsStudio010_16x9: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <Sequence from={scene1Start} durationInFrames={INTRO_DURATION}>
        <AbsoluteFill>
          <Video
            src={staticFile("ads-studio-010-16x9-intro.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      <Sequence from={scene2Start} durationInFrames={TITLE_DURATION}>
        <AbsoluteFill>
          <Video
            muted
            src={staticFile("ads-studio-010-16x9-title1.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      <Sequence from={scene3Start} durationInFrames={TITLE_DURATION}>
        <AbsoluteFill>
          <Video
            muted
            src={staticFile("ads-studio-010-16x9-title2.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      <Sequence from={scene5Start} durationInFrames={TITLE_DURATION}>
        <AbsoluteFill>
          <Video
            muted
            src={staticFile("ads-studio-010-16x9-title3.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      <Sequence from={scene7Start} durationInFrames={TITLE_DURATION}>
        <AbsoluteFill>
          <Video
            muted
            src={staticFile("ads-studio-010-16x9-title4.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
...
// Side-by-side videos 1 - left and right (16x9 layout)
...
// Side-by-side videos 2 - left and right (16x9 layout)
...
// Side-by-side videos 3 - left and right (16x9 layout, top aligned)
