...
// Video Clip Scene - reusable for all 3 clips
const VideoClipScene: React.FC<{ src: string }> = ({ src }) => {
  return (
    <AbsoluteFill
      style={{
...
// Combined Reordered Animation
export const DarwinReorderedAnimation: React.FC = () => {
  const { fps } = useVideoConfig();
  ...
  const logoOutroStart = extendedClip3Start + extendedClipDuration;
    ...
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <Audio 
        ...
        volume={(f) => interpolate(
          f,
          [0, 360, 450], // Fade out over last 3 seconds (frames 360-450)
          [1, 1, 0],
