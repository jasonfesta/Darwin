...
const SCENE2A_DURATION = 30; // 1 second (first shoe)
const SCENE2B_DURATION = 30; // 1 second (second shoe)
...
const SCENE5_DURATION = 45; // 1.5 seconds (full screen video 1)
const SCENE6_DURATION = 45; // 1.5 seconds (full screen video 2)
...
const TOTAL_DURATION = SCENE1_DURATION + SCENE2A_DURATION + SCENE2B_DURATION + SCENE3_DURATION + SCENE_TEXT_DURATION + SCENE4_DURATION + SCENE5_DURATION + SCENE6_DURATION + FINAL_TEXT_1_DURATION + FINAL_TEXT_2_DURATION + LOGO_OUTRO_DURATION + URL_SCENE_DURATION;

export const AdsStudio001: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      {/* Background music with fade out */}
      <BackgroundMusic />

      {/* Scene 1: Two videos stacked vertically (0 - 1.5s) */}
      <Sequence from={0} durationInFrames={SCENE1_DURATION}>
        <AbsoluteFill>
          {/* Top video - empty scene (no Prime drink) */}
          <div
            style={{
              position: "absolute",
              top: 0,
          ...
          >
            <Video
              muted
              startFrom={0}
              src={staticFile("ads-studio-001-bottom.mp4")}
              style={{
                width: "100%",
                height: "100%",
                objectFit: "cover",
          ...
          {/* Bottom video - scene with Prime drink, audio plays from this one */}
          <div
            style={{
              position: "absolute",
              top: "50%",
          ...
          >
            <Video
              startFrom={0}
              src={staticFile("ads-studio-001-top.mp4")}
              style={{
                width: "100%",
                height: "100%",
                objectFit: "cover",
      ...
      {/* Scene 2: First shoe - starts from beginning */}
      <Sequence from={SCENE1_DURATION} durationInFrames={SCENE2A_DURATION}>
        <AbsoluteFill>
          <Video
            src={staticFile("ads-studio-001-scene2b.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      {/* Scene 3: Second shoe - picks up from where Scene 2 left off */}
      <Sequence from={SCENE1_DURATION + SCENE2A_DURATION} durationInFrames={SCENE2B_DURATION}>
        <AbsoluteFill>
          <Video
            startFrom={SCENE2A_DURATION}
            src={staticFile("ads-studio-001-scene2a.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      {/* Scene 5: Stacked videos - 2 seconds (flipped) */}
      <Sequence from={SCENE1_DURATION + SCENE2A_DURATION + SCENE2B_DURATION + SCENE3_DURATION + SCENE_TEXT_DURATION} durationInFrames={SCENE4_DURATION}>
        <AbsoluteFill>
          {/* Top video - audio plays from this one */}
          <div
            style={{
              position: "absolute",
              top: 0,
          ...
          >
            <Video
              src={staticFile("ads-studio-001-scene5-bottom.mp4")}
              style={{
                width: "100%",
                height: "100%",
                objectFit: "cover",
          ...
          {/* Bottom video - muted to prevent overlap */}
          <div
            style={{
              position: "absolute",
              top: "50%",
          ...
          >
            <Video
              muted
              src={staticFile("ads-studio-001-scene5-top.mp4")}
              style={{
                width: "100%",
                height: "100%",
                objectFit: "cover",
      ...
      {/* Scene 6: Full screen video 1 - focus on left subject */}
      <Sequence from={SCENE1_DURATION + SCENE2A_DURATION + SCENE2B_DURATION + SCENE3_DURATION + SCENE_TEXT_DURATION + SCENE4_DURATION} durationInFrames={SCENE5_DURATION}>
        <AbsoluteFill>
          <Video
            src={staticFile("ads-studio-001-scene6.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      {/* Scene 7: Full screen video 2 - focus on left subject */}
      <Sequence from={SCENE1_DURATION + SCENE2A_DURATION + SCENE2B_DURATION + SCENE3_DURATION + SCENE_TEXT_DURATION + SCENE4_DURATION + SCENE5_DURATION} durationInFrames={SCENE6_DURATION}>
        <AbsoluteFill>
          <Video
            src={staticFile("ads-studio-001-scene7.mp4")}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
      ...
      {/* Scene 8: First final text - in and out */}
      <Sequence from={SCENE1_DURATION + SCENE2A_DURATION + SCENE2B_DURATION + SCENE3_DURATION + SCENE_TEXT_DURATION + SCENE4_DURATION + SCENE5_DURATION + SCENE6_DURATION} durationInFrames={FINAL_TEXT_1_DURATION}>
        <FinalMotionText1 />
      </Sequence>

      {/* Scene 8b: Second final text */}
      <Sequence from={SCENE1_DURATION + SCENE2A_DURATION + SCENE2B_DURATION + SCENE3_DURATION + SCENE_TEXT_DURATION + SCENE4_DURATION + SCENE5_DURATION + SCENE6_DURATION + FINAL_TEXT_1_DURATION} durationInFrames={FINAL_TEXT_2_DURATION}>
        <FinalMotionText2 />
      </Sequence>

      {/* Scene 9: Logo outro */}
      <Sequence from={SCENE1_DURATION + SCENE2A_DURATION + SCENE2B_DURATION + SCENE3_DURATION + SCENE_TEXT_DURATION + SCENE4_DURATION + SCENE5_DURATION + SCENE6_DURATION + FINAL_TEXT_1_DURATION + FINAL_TEXT_2_DURATION} durationInFrames={LOGO_OUTRO_DURATION}>
        <LogoOutro />
      </Sequence>

      {/* Scene 10: URL slide in */}
      <Sequence from={SCENE1_DURATION + SCENE2A_DURATION + SCENE2B_DURATION + SCENE3_DURATION + SCENE_TEXT_DURATION + SCENE4_DURATION + SCENE5_DURATION + SCENE6_DURATION + FINAL_TEXT_1_DURATION + FINAL_TEXT_2_DURATION + LOGO_OUTRO_DURATION} durationInFrames={URL_SCENE_DURATION}>
        <UrlSlideIn />
      </Sequence>
...
const BackgroundMusic: React.FC = () => {
  ...
  return (
    <Audio
      src={staticFile("launch-in-3d-bg.mp3")}
      volume={volume}
    />
  );
};
